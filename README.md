...
Este projeto foi desenvolvido como entrega da disciplina de Frontend da CESAR School, com foco em:
- manipulação de DOM,
- arquitetura de interface em páginas separadas,
- persistência local,
- interação dinâmica sem frameworks.
